...
public class runPreprocess {
	...
	public void testing(Bayes bayes, Preprocessing p, String test) throws Exception {
		System.out.println("bayesoutput-------------");
	 ...
	 * }
	 */
	public void testing(svm lr, Preprocessing p) throws Exception {
		System.out.println("svmoutput-------------");
		BufferedReader br = new BufferedReader(new FileReader("convertedtotxt.txt"));
		String rec = "";
		while ((rec = br.readLine()) != null) {
			String[] words = rec.split(" ");
